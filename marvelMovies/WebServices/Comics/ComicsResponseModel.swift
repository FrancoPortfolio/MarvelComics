...
//
//   let comics = try? JSONDecoder().decode(Comics.self, from: jsonData)
...
//    let dates: [DateElement]
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case title, issueNumber, variantDescription, description, isbn, upc, diamondCode, ean, issn, format, pageCount, textObjects, resourceURI, series, variants, collections, collectedIssues, prices, thumbnail, images, creators, characters, stories, events
    }
}
...
enum Isbn: String, Codable {
    ...
    case the0785115609 = "0-7851-1560-9"
}
